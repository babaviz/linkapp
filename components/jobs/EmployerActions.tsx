...
type JobsScreenNavigationProp = StackNavigationProp<JobsStackParamList, 'JobsMain'>;
...
export default function EmployerActions({ 
  ...
  const handleViewAnalytics = () => {
    onClose();
    // Navigate to analytics/stats - can be customized
    navigation.navigate('MyPostings');
  };
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ 
                  ...
                  Create a new job posting in {category || 'this category'}
                </Text>
              </View>
