    ...
    Tables: {
      ...
      date_mi_profiles: {
        Row: {
          ...
          id: string
          intention: 'short_term_fun' | 'long_term_partner' | null
      ...
      datemi_matching_preferences: {
        Row: {
          ...
          intention_preference: string[] | null
          verified_only: boolean | null
          creators_only: boolean | null
          activity_level: string | null
          communication_style: string[] | null
          lifestyle_preferences: string[] | null
          deal_breakers: string[] | null
          preferred_meeting_style: string | null
        }
        Insert: {
          id?: string
          created_at?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "datemi_matching_preferences_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      datemi_user_behavior: {
        ...
        Relationships: [
          {
            foreignKeyName: "datemi_user_behavior_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "users"
            referencedColumns: ["id"]
